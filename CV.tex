...
\section{Summary}
Senior software developer with a PhD in Computers Architecture and
High Performance Computing (HPC) with over than 12 years developing
and optimizing hybrid parallel applications for multiple
architectures, languages and infrastructures. Developed the task based
programming model
\href{https://github.com/bsc-pm/ompss-2-cluster-releases}{OmpSs2@Cluster}
and the instrument based profiler for C++ parallel applications
\href{https://github.com/Ergus/ExtraeWin}{ExtraeWin}. Regular
contributor to the Emacs Project and maintainer of some packages
...
\begin{tabularx}{\linewidth}{@{}l X@{}}
  ...
  Programming & \textbf{Advanced}:
                ...
                \href{https://nvidia.github.io/cccl/thrust/}{Thrust}, \href{https://developer.nvidia.com/cublas}{cuBLAS}),
                Fortran,
                \href{https://www.intel.com/content/www/us/en/developer/tools/oneapi/onetbb.html}{Intel TBB},
                Lisp,
