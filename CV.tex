...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  ...
  \href{https://www.ust.com/es}{UST} Senior Developer External Consultant @ (\href{https://www.bbva.es/}{BBVA} Bank) &  \\
  ...
  \begin{minipage}[t]{\linewidth}
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          ...
          \item[--] Modify a section of the Gaudi simulator to optimize
              ...
              \href{https://developer.nvidia.com/cuda-zone}{Cuda} and auto-vectorization techniques and OpenMP.
      \end{itemize}
  \end{minipage}
  }
\end{tabularx}
