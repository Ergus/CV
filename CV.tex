...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  ...
  \href{https://www.ust.com/es}{UST} External Consultant
  @ Bilbao-Vizcaya-Argentaria Bank (\href{https://www.bbva.es/}{BBVA}) &  \\
  ...
  \begin{minipage}[t]{\linewidth}
      ...
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[--] Projection model implementation for valuation adjustment (CVA, FVA).
          \item[--] Implement and optimize models from prototype (Excel\,\&\,C\#) to production
              (\CC\,\&\,Protobuf\,\&\,client-server).
          \item[--] Implement profiles, benchmarks and automatic unit tests.
          \item[--] Use and interact with large existing code base (multiple
              languages, architectures and implementation paradigms).
      \end{itemize}
  \end{minipage}
  }
\end{tabularx}
