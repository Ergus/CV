  ...
  \begin{minipage}[t]{\linewidth}
      ...
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[--] Design and implement risk valuation models (CVA, FVA)
              ...
              architectures. Results in more maintainable code usually ~1.5x-3x faster than original.
          \item[--] Profile, instrument and benchmark existing code to detect
              issues and optimization opportunities and modernize executions benefit
              from modern advanced infrastructures.
  ...
  \begin{minipage}[t]{\linewidth}
      ...
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          ...
          \item[--] Hybrid Parallel Programming (distributed/shared memory,
              ...
              non-blocking). Parallel Application benchmark, profile, analysis,
              instrumentation and optimization tools.
          \item[--] Extend the \href{https://tools.bsc.es/extrae}{Extrae} parallel profiler to provide more accurate traces for our model.
