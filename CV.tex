...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  ...
  \begin{minipage}[t]{\linewidth}
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[--] Design and implement models for high performance shared
              and distributed heterogeneous parallel architectures from
          ...
          \item[--] Mentor junior developers to encourage the use of correct design patterns,
...
\begin{tabularx}{\linewidth}{@{}l X@{}}
  ...
  2014--2016 & \textbf{Master Degree on High Performance Computing (MHPC)} \href{http://www.mhpc.it}{[Link]}
               ...
               the hardware capabilities using MPI, pthreads and GPGPU programming with
