...
\section{Summary}
Senior developer with a PhD in Computers Architecture and High
performance computing (HPC) with over than 12 years developing and
optimizing hybrid parallel applications for multiple architectures,
languages and infrastructures. Developed the task based programming
model
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  \textbf{Senior Software Developer} & \hfill 2023-today \\
  ...
  \begin{minipage}[t]{\linewidth}
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[--] Design, implement and optimize numerical models for high
              performance shared and distributed heterogeneous parallel architectures from
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  \textbf{Assistant professor of Numerical Methods and Differential Equations} & \hfill 2011--2014 \\
