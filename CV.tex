...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
  ...
  \begin{minipage}[t]{\linewidth}
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          \item[--] Design and implement risk valuation models (CVA, FVA)
              for high performance shared and distributed heterogeneous parallel
              architectures. Resulting in a more maintainable code usually ~1.5x-3x
              faster than original.
          \item[--] Profile, instrument and benchmark to detect issues and
              optimization opportunities and modernize executions benefit from
              modern advanced infrastructures.
          \item[--] Additionally, mentored junior developers resulting in an 80\% decrease in
              turnaround time for development projects.
      \end{itemize}
  \end{minipage}
  }
\end{tabularx}
  ...
  \begin{minipage}[t]{\linewidth}
      ...
      \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
          ...
          \item[--] Hybrid Parallel Programming (distributed/shared memory,
              multi-process, multi-threading, task programming model, IPC, lock-free,
              non-blocking).
          ...
          \item[--] Language interoperability programming (C/\CC/Fortran/Python).
              ...
              Application and library development test, debug and profile automation. Modify the
              \href{https://pm.bsc.es/mcxx}{mercurium} compiler to support the
              \href{https://github.com/bsc-pm/ompss-2-cluster-releases}{OmpSs2@Custer}
              requirements for C,\CC and Fortran.
